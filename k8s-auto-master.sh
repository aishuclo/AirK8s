...
sudo -u user -i /bin/bash -c "scp user@$AIR_K8S_SERVER:/home/user/tigera-operator.yaml ."
sudo -u user -i /bin/bash -c "kubectl create -f tigera-operator.yaml"

sudo -u user -i /bin/bash -c "scp user@$AIR_K8S_SERVER:/home/user/custom-resources.yaml ."
